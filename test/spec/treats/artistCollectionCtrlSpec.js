...
describe('artistCollectionCtrl', function () {
    ...
    beforeEach( inject( function($rootScope, $controller){
        ...
        createController = function() {
            return $controller('artistCollectionCtrl', {
                '$scope': $scope,
    ...
    it('calls artistCatalogue to get artists and places response on scope when successful', inject(function($q) {
        given:
